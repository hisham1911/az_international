  ...
  return (
    <section className="relative overflow-hidden bg-blue-600 py-16 text-white">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-10 left-10 h-20 w-20 rounded-full bg-blue-400 opacity-10"></div>
        <div className="absolute bottom-0 right-1/4 h-32 w-32 rounded-full bg-blue-700 opacity-15"></div>
      </div>
